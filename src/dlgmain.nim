...
proc runMainDialog*(passPhrase: string): bool =
  ...
  setAttribute(listRecordsUids, "SPACING", "0") 
  setAttribute(listRecordsUids, "VISIBLELINES", "0")  
  ...
  var vboxListRecords = vbox(nil)
  setAttribute(vboxListRecords, "ALIGNMENT", "ALEFT") 
  setAttribute(vboxListRecords, "EXPAND", "YES") 
  setAttribute(vboxListRecords, "HORIZONTALFREE", "YES") 
  setAttribute(vboxListRecords, "MARGIN", "5x5")
  setAttribute(vboxListRecords, "GAP", "0")
  discard insert(vboxListRecords, nil, listRecordsUids)
  discard insert(vboxListRecords, nil, listRecordsTitle)
  ...
  discard insert(vboxMain, nil, vboxListRecords)
